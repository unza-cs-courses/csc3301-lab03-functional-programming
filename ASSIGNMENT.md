...
### Map Test
- **Input data:** `[2, 6, 1, 8, 4]`
- **Transformation:** multiply by 4
- **Expected output:** `[8, 24, 4, 32, 16]`

### Filter Test
- **Input data:** `[5, 15, 9, 6, 2, 11]`
- **Predicate:** odd numbers
- **Expected output:** `[5, 15, 9, 11]`

### Reduce Test
- **Input data:** `[8, 7, 9, 1, 6]`
- **Operation:** concatenation
- **Initial value:** ``
- **Expected output:** `87916`

### Zip-With Test
- **List 1:** `[3, 6, 5, 2]`
- **List 2:** `[3, 4, 5, 10]`
- **Operation:** subtract pairs
- **Expected output:** `[0, 2, 0, -8]`
...
**Initial data:** `[17, 18, 3, 12, 9, 6, 15, 8]`

**Chain:**
1. Filter: keep values > 5
2. Map: multiply by 3
